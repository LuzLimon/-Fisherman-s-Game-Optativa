...
window.addEventListener('load', function () {
    ...
    class Game {
        ...
        addEnemy() {
            ...
            else if (randomize < 0.6) this.enemies.push(new BulbWhale(this));
            else if (randomize < 0.7) this.enemies.push(new MoonFish(this));
            else if (randomize < 0.8) this.enemies.push(new Stalker(this));
            else if (randomize < 0.9) this.enemies.push(new Razorfin(this));
